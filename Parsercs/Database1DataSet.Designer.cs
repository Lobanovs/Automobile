...
namespace Parsercs.Database1DataSetTableAdapters {
...
SELECT Id, City, Mark, Model, Price, Description, YearOfIssue, Mileage, Color FROM Auto WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Id, City, Mark, Model, Price, Description, YearOfIssue, Mileage, Color FRO" +
                "M dbo.Auto";
        ...
        public virtual int FillBy(Database1DataSet.AutoDataTable dataTable) {
